...
class LPAMLP(nn.Module):
    ...
    def forward(self, pf):
        ...
        # print("\033[91mLPAMLP Data Output: \033[0m", f.shape)
        return p,f
...
class SPoTrEncoder(nn.Module):
    def __init__(self,
                 ...
                 group_args: dict = {'NAME': 'ballquery', 'radius': 0.1, 'nsample': 16},
                 num_layers: int = 1,
                 **kwargs
                 ):
        super().__init__()
        ...
        self.conv_args = kwargs.get('conv_args', {'order' : 'conv-norm-act'})
    ...
    # def forward_point_feat(self, p0, f0=None):
    #     if hasattr(p0, 'keys'):
