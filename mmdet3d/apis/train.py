...
from mmdet3d.core.hooks import DistEvalHook
...
def train_model(
    ...
    if validate:
        ...
        val_samples_per_gpu = cfg.data.pop("val_samples_per_gpu", 1)
    ...
    # runner.model.module.net.load_reid_nets()
